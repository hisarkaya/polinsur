...
class Dashboard extends Component {
  ...
  componentDidMount() {
    this.props.setNavigation('dashboard', 'dashboard', 'home');
  }
        ...
        <ul className="quick-actions">
          ...
          <li className="bg_lb">
            <a href="interface.html">
              <i className="icon-pencil"></i>Elements</a>
          </li>
          <li className="bg_lg">
...
export default connect(null, {setNavigation})(Dashboard);
